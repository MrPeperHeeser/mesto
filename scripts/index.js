...
const nameInput = document.querySelector('[class="popup__form-input"][title="username"]');
const jobInput = document.querySelector('[class="popup__form-input"][title="description"]');
